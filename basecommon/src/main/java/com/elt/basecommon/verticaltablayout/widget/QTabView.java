...
public class QTabView extends TabView {
    ...
    public void setChecked(boolean checked) {
        ...
        if (mChecked) {
            ...
            mTitle.setTextSize(mTabTitle.getTitleTextSizeSelected());
            TextPaint paint = mTitle.getPaint();
            paint.setFakeBoldText(false);//设置字体粗体，这里取消
            mContainer.setBackgroundColor(0xFFF6F6F6);//设置背景
            ...
            mTitle.setTextColor(mTabTitle.getColorNormal());
            mTitle.setTextSize(mTabTitle.getTitleTextSize());
//            mTitle.setBackgroundColor(0xff000000);
            TextPaint paint = mTitle.getPaint();
            ...
            mContainer.setBackgroundColor(0xFFF6F6F6);
        }
    }
