package com.elt.basecommon.verticaltablayout;
...
import com.elt.basecommon.verticaltablayout.adapter.TabAdapter;
import com.elt.basecommon.verticaltablayout.util.DisplayUtil;
import com.elt.basecommon.verticaltablayout.util.TabFragmentManager;
import com.elt.basecommon.verticaltablayout.widget.QTabView;
import com.elt.basecommon.verticaltablayout.widget.TabIndicator;
...
public class VerticalTabLayout extends ScrollView {
    ...
    public void setTabMode(int mode) {
        ...
        mTabStrip.post(new Runnable() {
            @Override
            public void run() {
                mTabStrip.updateIndicatorMargin();
            }
        });
    }
    ...
    private class TabStrip extends LinearLayout {
        ...
        protected void updateIndicatorMargin() {
