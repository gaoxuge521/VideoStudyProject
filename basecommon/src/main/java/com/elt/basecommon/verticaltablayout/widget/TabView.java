...
public abstract class TabView extends FrameLayout implements Checkable {
    ...
    public static class TabTitle {
        ...
        public int getTitleTextSizeSelected() {
            return mBuilder.mTitleSizeSelected;
        }
        ...
        public static class Builder {
            ...
            private int mTitleSizeSelected;
            ...
            public Builder setTextSize(int sizeSpSelected, int sizeSpNormal) {
                mTitleTextSize = sizeSpSelected;
                mTitleSizeSelected = sizeSpNormal;
                return this;
            }
