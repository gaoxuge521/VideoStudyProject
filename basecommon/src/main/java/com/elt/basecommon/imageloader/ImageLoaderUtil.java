...
public class ImageLoaderUtil {
     ...
     */
    public void loadCircleImg(Context context, ImageLoaders img,int borderWidth,int borderColor){
     ...
     * @param radius
     */
    public void loadRoundImage(Context context, ImageLoaders img,int radius){
        mStrategy.loadRoundImage(context,img,radius);
    }
    //加载正常的图片
    public void loadImage(Context context, ImageLoaders img) {
